...
//used for the next/back buttons
	...
	if (!empty($nextPhotoID)) {
		$nextLink = "<td align=\"right\" width=\"10%\" valign=\"top\" ><a href=\"cityPhoto.php?id=" .  $nextPhotoID . "\"><h3><img src=\"next.png\" style=\"border:0px\"></h3></a></td>"; 
	}
	...
	if (!empty($previousPhotoID)) {
		$backLink = "<td align=\"left\" width=\"10%\" valign=\"top\" ><a href=\"cityPhoto.php?id=" .  $previousPhotoID . "\"><h3><img src=\"back.png\" style=\"border:0px\"></h3></a></td>"; 
	}
